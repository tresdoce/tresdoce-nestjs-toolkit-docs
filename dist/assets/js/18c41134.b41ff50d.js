  ...
  [2859],
  {
    3905: (e, t, n) => {
      ...
      var l = a.createContext({}),
        ...
        p = a.forwardRef(function (e, t) {
          ...
          return n
            ? a.createElement(k, s(s({ ref: t }, u), {}, { components: n }))
    ...
    3494: (e, t, n) => {
        ...
        u = (e) => {
          ...
          return (0, r.kt)(
            'span',
            {
              ...
              onClick: () => {
                alert('You clicked the color ' + n + ' with label ' + t);
              },
            },
            t,
          );
      ...
      function p(e) {
        ...
        return (0, r.kt)(
          'wrapper',
          (0, a.Z)({}, d, o, { components: t, mdxType: 'MDXLayout' }),
          (0, r.kt)('h1', { id: 'markdown-features' }, 'Markdown Features'),
          (0, r.kt)(
            'p',
            null,
            'Docusaurus supports ',
            ...
            ' and a few ',
            (0, r.kt)('strong', { parentName: 'p' }, 'additional features'),
            '.',
          ),
          (0, r.kt)('h2', { id: 'front-matter' }, 'Front Matter'),
          (0, r.kt)(
            'p',
            null,
            ...
            (0, r.kt)(
              'a',
              { parentName: 'p', href: 'https://jekyllrb.com/docs/front-matter/' },
              'Front Matter',
            ),
            ':',
          ),
          ...
          (0, r.kt)(
            ...
            (0, r.kt)(
              'a',
              { parentName: 'p', href: '/docs/tutorial-basics/create-a-page' },
              'Create a page',
            ),
            '.',
          ),
          (0, r.kt)('h2', { id: 'images' }, 'Images'),
          (0, r.kt)('p', null, 'Regular Markdown images are supported.'),
          (0, r.kt)(
            'p',
            null,
            'You can use absolute paths to reference images in the static directory (',
            (0, r.kt)('inlineCode', { parentName: 'p' }, 'static/img/docusaurus.png'),
            '):',
          ),
          (0, r.kt)(
            'pre',
          ...
          (0, r.kt)(
            ...
            (0, r.kt)(
              'a',
              { parentName: 'p', href: '/docs/tutorial-extras/manage-docs-versions' },
              'the extra guides',
            ),
            '.',
          ),
          (0, r.kt)('h2', { id: 'code-blocks' }, 'Code Blocks'),
          (0, r.kt)('p', null, 'Markdown code blocks are supported with Syntax highlighting.'),
          (0, r.kt)(
            'pre',
            null,
            (0, r.kt)(
          ...
          (0, r.kt)('h2', { id: 'admonitions' }, 'Admonitions'),
          (0, r.kt)(
            'p',
            null,
          ...
          (0, r.kt)(
            ...
            (0, r.kt)(
              ...
              (0, r.kt)('p', { parentName: 'div' }, 'Use this awesome feature option'),
            ),
          ),
          (0, r.kt)(
            'div',
            ...
            (0, r.kt)(
              'div',
              { parentName: 'div', className: 'admonition-content' },
              (0, r.kt)('p', { parentName: 'div' }, 'This action is dangerous'),
            ),
          ),
          (0, r.kt)('h2', { id: 'mdx-and-react-components' }, 'MDX and React Components'),
          (0, r.kt)(
            'p',
            null,
            (0, r.kt)('a', { parentName: 'p', href: 'https://mdxjs.com/' }, 'MDX'),
            ' can make your documentation more ',
            (0, r.kt)('strong', { parentName: 'p' }, 'interactive'),
            ' and allows using any ',
            (0, r.kt)('strong', { parentName: 'p' }, 'React components inside Markdown'),
            ':',
          ),
          (0, r.kt)(
            'pre',
          ...
          (0, r.kt)(
            ...
            null,
            'This is ',
            (0, r.kt)(u, { color: '#25c2a0', mdxType: 'Highlight' }, 'Docusaurus green'),
            ' !',
          ),
          (0, r.kt)(
            'p',
            null,
            'This is ',
            (0, r.kt)(u, { color: '#1877F2', mdxType: 'Highlight' }, 'Facebook blue'),
            ' !',
          ),
        );
      }
