  ...
  [6755],
  {
    3905: (e, t, n) => {
      ...
      var s = a.createContext({}),
        ...
        p = a.forwardRef(function (e, t) {
          ...
          return n
            ? a.createElement(f, l(l({ ref: t }, u), {}, { components: n }))
            : a.createElement(f, l({ ref: t }, u));
        });
      function m(e, t) {
        var n = arguments,
          r = t && t.mdxType;
        if ('string' == typeof e || r) {
          ...
          (i.originalType = e), (i.mdxType = 'string' == typeof e ? e : r), (l[1] = i);
    ...
    740: (e, t, n) => {
      ...
      function d(e) {
        ...
        return (0, r.kt)(
          'wrapper',
          (0, a.Z)({}, u, o, { components: t, mdxType: 'MDXLayout' }),
          (0, r.kt)('h1', { id: 'translate-your-site' }, 'Translate your site'),
          (0, r.kt)(
            'p',
            null,
            "Let's translate ",
            (0, r.kt)('inlineCode', { parentName: 'p' }, 'docs/intro.md'),
            ' to French.',
          ),
          (0, r.kt)('h2', { id: 'configure-i18n' }, 'Configure i18n'),
          (0, r.kt)(
            'p',
            null,
            'Modify ',
            (0, r.kt)('inlineCode', { parentName: 'p' }, 'docusaurus.config.js'),
          ...
          (0, r.kt)('h2', { id: 'translate-a-doc' }, 'Translate a doc'),
          (0, r.kt)(
            'p',
            null,
            'Copy the ',
          ...
          (0, r.kt)('h2', { id: 'start-your-localized-site' }, 'Start your localized site'),
          (0, r.kt)('p', null, 'Start your site on the French locale:'),
          (0, r.kt)(
            'pre',
            null,
            (0, r.kt)(
          ...
          (0, r.kt)(
            ...
            (0, r.kt)('inlineCode', { parentName: 'p' }, 'http://localhost:3000/fr/'),
            ' and the ',
            (0, r.kt)('inlineCode', { parentName: 'p' }, 'Getting Started'),
            ' page is translated.',
          ),
          (0, r.kt)(
            'div',
          ...
          (0, r.kt)('h2', { id: 'add-a-locale-dropdown' }, 'Add a Locale Dropdown'),
          (0, r.kt)('p', null, 'To navigate seamlessly across languages, add a locale dropdown.'),
          (0, r.kt)(
            'p',
            null,
            'Modify the ',
          ...
          (0, r.kt)('p', null, 'The locale dropdown now appears in your navbar:'),
          (0, r.kt)(
            'p',
            null,
            (0, r.kt)('img', {
          ...
          (0, r.kt)('h2', { id: 'build-your-localized-site' }, 'Build your localized site'),
          (0, r.kt)('p', null, 'Build your site for a specific locale:'),
          (0, r.kt)(
            'pre',
            null,
            (0, r.kt)(
          ...
          (0, r.kt)('p', null, 'Or build your site to include all the locales at once:'),
          (0, r.kt)(
            'pre',
            null,
            (0, r.kt)('code', { parentName: 'pre', className: 'language-bash' }, 'npm run build\n'),
          ),
        );
      }
      d.isMDXComponent = !0;
    ...
    7541: (e, t, n) => {
      n.d(t, { Z: () => a });
      const a = n.p + 'assets/images/localeDropdown-f0d995e751e7656a1b0dbbc1134e49c2.png';
    },
  },
]);
