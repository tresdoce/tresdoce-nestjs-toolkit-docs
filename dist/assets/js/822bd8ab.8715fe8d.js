  ...
  [6504],
  {
      ...
      var u = a.createContext({}),
        ...
        m = a.forwardRef(function (t, e) {
          var r = t.components,
            ...
            o = t.originalType,
            u = t.parentName,
            c = i(t, ['components', 'mdxType', 'originalType', 'parentName']),
            m = l(r),
            d = n,
            f = m[''.concat(u, '.').concat(d)] || m[d] || p[d] || o;
          return r
            ? a.createElement(f, s(s({ ref: e }, c), {}, { components: r }))
            : a.createElement(f, s({ ref: e }, c));
        });
      function d(t, e) {
        var r = arguments,
          n = e && e.mdxType;
        if ('string' == typeof t || n) {
          ...
          (i.originalType = t), (i.mdxType = 'string' == typeof t ? t : n), (s[1] = i);
    ...
    7428: (t, e, r) => {
      ...
      const o = { sidebar_position: 6 },
        ...
        u = {},
        l = [{ value: 'What&#39;s next?', id: 'whats-next', level: 2 }],
        c = { toc: l };
      function p(t) {
        let { components: e, ...r } = t;
        return (0, n.kt)(
          'wrapper',
          (0, a.Z)({}, c, r, { components: e, mdxType: 'MDXLayout' }),
          ...
          (0, n.kt)(
            ...
            (0, n.kt)(
              ...
              (0, n.kt)(
                'a',
                { parentName: 'strong', href: '/docs/tutorial-extras/translate-your-site' },
                'i18n',
              ),
            ),
            '.',
