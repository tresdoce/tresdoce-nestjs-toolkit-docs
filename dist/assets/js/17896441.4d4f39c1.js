...
(self.webpackChunktresdoce_nestjs_toolkit_docs =
  ...
  [7918],
  {
    7684: (e, t, a) => {
      ...
      function p(e) {
        let { children: t, active: a, index: s, addMicrodata: c } = e;
        return l.createElement(
          'li',
          (0, n.Z)(
            {},
          ...
          t,
          l.createElement('meta', { itemProp: 'position', content: String(s + 1) }),
        );
      }
      function h() {
        const e = (0, d.Z)('/');
      ...
      function g() {
        ...
        return e
          ? l.createElement(
              'nav',
              {
                className: (0, r.Z)(i.k.docs.docBreadcrumbs, v.breadcrumbsContainer),
                'aria-label': (0, m.I)({
              ...
              l.createElement(
                ...
                e.map((t, a) => {
                  ...
                  return l.createElement(
                    ...
                    l.createElement(b, { href: t.href, isLast: n }, t.label),
                  );
                }),
              ),
            )
    ...
    1799: (e, t, a) => {
        ...
        return n.createElement(
          ...
          n.createElement(
            m.Z,
            {
              ...
              values: {
                atDate:
                  t && a ? n.createElement(u, { lastUpdatedAt: t, formattedLastUpdatedAt: a }) : '',
                byUser: l ? n.createElement(v, { lastUpdatedBy: l }) : '',
              },
            },
      ...
      var p = a(6114),
        h = a(1526);
      const g = 'lastUpdated_vbeJ';
      function E(e) {
        return n.createElement(
          'div',
          { className: (0, l.Z)(c.k.docs.docFooterTagsRow, 'row margin-bottom--sm') },
          n.createElement('div', { className: 'col' }, n.createElement(h.Z, e)),
        );
      }
      function f(e) {
        let { editUrl: t, lastUpdatedAt: a, lastUpdatedBy: r, formattedLastUpdatedAt: s } = e;
        return n.createElement(
          'div',
          { className: (0, l.Z)(c.k.docs.docFooterEditMetaRow, 'row') },
          n.createElement('div', { className: 'col' }, t && n.createElement(p.Z, { editUrl: t })),
          n.createElement(
            'div',
            { className: (0, l.Z)('col', g) },
            (a || r) &&
              n.createElement(b, { lastUpdatedAt: a, formattedLastUpdatedAt: s, lastUpdatedBy: r }),
          ),
        );
      }
      function L(e) {
        ...
        return m || u
          ? n.createElement(
              'footer',
              { className: (0, l.Z)(c.k.docs.docFooter, 'docusaurus-mt-lg') },
              m && n.createElement(E, { tags: d }),
              u &&
                n.createElement(f, {
                  editUrl: r,
                  lastUpdatedAt: s,
      ...
      var N = a(9407),
        ...
        _ = a(3743),
        k = a(7462);
      const C = 'tocCollapsibleButton_TO0P',
        T = 'tocCollapsibleButtonExpanded_MG3E';
      function H(e) {
        let { collapsed: t, ...a } = e;
        return n.createElement(
          'button',
          (0, k.Z)({ type: 'button' }, a, {
            className: (0, l.Z)('clean-btn', C, !t && T, a.className),
          }),
          n.createElement(
            m.Z,
            {
      ...
      const x = 'tocCollapsible_ETCw',
        U = 'tocCollapsibleContent_vkbj',
        y = 'tocCollapsibleExpanded_sAul';
      function A(e) {
        let { toc: t, className: a, minHeadingLevel: r, maxHeadingLevel: s } = e;
        const { collapsed: c, toggleCollapsed: i } = (0, Z.u)({ initialState: !0 });
        return n.createElement(
          'div',
          { className: (0, l.Z)(x, !c && y, a) },
          n.createElement(H, { collapsed: c, onClick: i }),
          n.createElement(
            Z.z,
            { lazy: !0, className: U, collapsed: c },
            n.createElement(_.Z, { toc: t, minHeadingLevel: r, maxHeadingLevel: s }),
          ),
        );
      }
      var w = a(2503),
        I = a(7684),
        M = a(3548);
      const B = 'docItemContainer_Adtb',
        O = 'docItemCol_GujU',
        V = 'tocMobile_aoJ5';
      function S(e) {
        var t;
        const { content: a } = e,
          { metadata: l, frontMatter: s, assets: c } = a,
          { keywords: i } = s,
          { description: o, title: d } = l,
          m = null != (t = c.image) ? t : s.image;
        return n.createElement(r.d, { title: d, description: o, keywords: i, image: m });
      }
      function P(e) {
        const { content: t } = e,
          { metadata: a, frontMatter: r } = t,
          {
            ...
            toc_min_heading_level: v,
            toc_max_heading_level: b,
          } = r,
          { title: p } = a,
          h = !m && void 0 === t.contentTitle,
          g = (0, s.i)(),
          E = !u && t.toc && t.toc.length > 0,
          f = E && ('desktop' === g || 'ssr' === g);
        return n.createElement(
          'div',
          { className: 'row' },
              ...
              n.createElement(
                ...
                E &&
                  n.createElement(A, {
                    ...
                    minHeadingLevel: v,
                    maxHeadingLevel: b,
                    className: (0, l.Z)(c.k.docs.docTocMobile, V),
                  }),
                n.createElement(
                  'div',
                  { className: (0, l.Z)(c.k.docs.docMarkdown, 'markdown') },
                  h && n.createElement('header', null, n.createElement(w.Z, { as: 'h1' }, p)),
                  n.createElement(M.Z, null, n.createElement(t, null)),
                ),
                n.createElement(L, e),
              ),
              n.createElement(i.Z, { previous: a.previous, next: a.next }),
            ),
          ),
          f &&
            n.createElement(
    ...
    4364: (e, t, a) => {
      ...
      function i(e) {
        ...
        return a.badge
          ? n.createElement(
              'span',
              { className: (0, l.Z)(t, c.k.docs.docVersionBadge, 'badge badge--secondary') },
              n.createElement(
                r.Z,
    ...
    3120: (e, t, a) => {
      ...
      function p(e) {
        ...
        const {
          ...
          { pluginId: c } = (0, i.gA)({ failfast: !0 }),
          { savePreferredVersionName: m } = (0, o.J)(c),
          { latestDocSuggestion: u, latestVersionSuggestion: p } = (0, i.Jo)(c),
          h = null != u ? u : (g = p).docs.find((e) => e.id === g.mainDocId);
        var g;
        return n.createElement(
          'div',
          {
            className: (0, l.Z)(
              t,
              d.k.docs.docVersionBanner,
              'alert alert--warning margin-bottom--md',
            ),
            role: 'alert',
          },
          n.createElement('div', null, n.createElement(v, { siteTitle: s, versionMetadata: a })),
          n.createElement(
            'div',
            { className: 'margin-top--md' },
            n.createElement(b, { versionLabel: p.label, to: h.path, onClick: () => m(p.name) }),
          ),
        );
      }
      function h(e) {
    ...
    2244: (e, t, a) => {
      ...
      var n = a(7294),
        ...
        r = a(9960);
      function s(e) {
        const { permalink: t, title: a, subLabel: s, isNext: c } = e;
        return n.createElement(
          r.Z,
          {
            className: (0, l.Z)(
          ...
          s && n.createElement('div', { className: 'pagination-nav__sublabel' }, s),
    ...
    9407: (e, t, a) => {
      ...
      var n = a(7462),
        ...
        r = a(6010),
        s = a(3743);
      const c = 'tableOfContents_bqdL';
      function i(e) {
        let { className: t, ...a } = e;
        return l.createElement(
          'div',
          { className: (0, r.Z)(c, 'thin-scrollbar', t) },
          l.createElement(
            s.Z,
            (0, n.Z)({}, a, {
    ...
    3743: (e, t, a) => {
        ...
        (0, l.useEffect)(() => {
          ...
          function c() {
            const e = (function (e) {
              ...
              i = o(c, { anchorTopOffset: a.current }),
              d = e.find(
                (e) =>
                  i &&
                  i.id ===
            ...
            e.forEach((e) => {
              !(function (e, a) {
                a
                  ? (t.current && t.current !== e && t.current.classList.remove(l),
                    e.classList.add(l),
                    (t.current = e))
      ...
      function b(e) {
        ...
        const p = (0, c.L)(),
          h = null != d ? d : p.tableOfContents.minHeadingLevel,
          g = null != u ? u : p.tableOfContents.maxHeadingLevel,
          E = (function (e) {
            let { toc: t, minHeadingLevel: a, maxHeadingLevel: n } = e;
            return (0, l.useMemo)(
              () => s({ toc: r(t), minHeadingLevel: a, maxHeadingLevel: n }),
              [t, a, n],
            );
        ...
        return (
          ...
          l.createElement(v, (0, n.Z)({ toc: E, className: a, linkClassName: i }, b))
        );
      }
    },
    3008: (e, t, a) => {
      ...
      function o(e) {
        ...
        return n.createElement(
          r.Z,
          { href: t, className: (0, l.Z)(s, o ? i : c) },
          a,
    ...
    1526: (e, t, a) => {
      ...
      function o(e) {
        ...
        return n.createElement(
          ...
          n.createElement(
            'ul',
            { className: (0, l.Z)(c, 'padding--none', 'margin-left--sm') },
            t.map((e) => {
              let { label: t, permalink: a } = e;
              return n.createElement(
                'li',
                { key: a, className: i },
                n.createElement(s.Z, { label: t, permalink: a }),
              );
            }),
          ),
        );
