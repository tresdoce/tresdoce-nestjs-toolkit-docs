    ...
    7994: (e, t, n) => {
      ...
      function f() {
        ...
        return a.createElement('button', {
          ...
          className: (0, l.Z)('clean-btn', i.k.common.backToTopButton, h, e && E),
          type: 'button',
          onClick: t,
        });
      }
      ...
      function P(e) {
        ...
        const { items: m, label: u, collapsible: b, className: p, href: h } = t,
          ...
          f = (function (e) {
            const t = (0, B.Z)();
            return (0, a.useMemo)(
              () => (e.href ? e.href : !t && e.collapsible ? (0, o.Wl)(e) : void 0),
              [e, t],
            );
          })(t),
          _ = (0, o._F)(t, r),
          g = (0, M.Mg)(h, r),
          { collapsed: k, setCollapsed: I } = (0, F.u)({
            initialState: () => !!b && !_ && t.collapsed,
          }),
        ...
        return (
          ...
          })({ isActive: _, collapsed: k, updateCollapsed: Z }),
          (0, a.useEffect)(() => {
            b && N && N !== s && E && I(!0);
          }, [b, N, s, I, E]),
          a.createElement(
            'li',
            {
              className: (0, l.Z)(
                ...
                i.k.docs.docSidebarItemCategoryLevel(c),
                'menu__list-item',
      ...
      function z(e) {
        let { item: t, onItemClick: n, activePath: r, level: c, index: s, ...d } = e;
        const { href: m, label: u, className: b } = t,
          p = (0, o._F)(t, r),
          h = (0, W.Z)(m);
        return a.createElement(
          'li',
          {
            className: (0, l.Z)(
              ...
              i.k.docs.docSidebarItemLinkLevel(c),
              'menu__list-item',
              b,
            ),
            key: u,
          ...
          a.createElement(
            ...
            (0, C.Z)(
              {
                className: (0, l.Z)('menu__link', !h && R, { 'menu__link--active': p }),
                'aria-current': p ? 'page' : void 0,
                to: m,
              },
              h && { onClick: n ? () => n(t) : void 0 },
              d,
            ),
            u,
            !h && a.createElement(D.Z, null),
          ),
        );
      }
      ...
      function K(e) {
        ...
        const { value: r, defaultStyle: c, className: s } = t;
      ...
      function O(e) {
        ...
        return a.createElement(
          'nav',
          { className: (0, l.Z)('menu thin-scrollbar', Y, r && q, o) },
          a.createElement(
            'ul',
            { className: (0, l.Z)(i.k.docs.docSidebarMenu, 'menu__list') },
      ...
      function oe(e) {
        return a.createElement(ae.Zo, { component: le, props: e });
      }
      const re = a.memo(oe);
      function ce(e) {
        const t = (0, g.i)(),
      ...
      function pe(e) {
        ...
        return a.createElement(
          'aside',
          {
            className: (0, l.Z)(i.k.docs.docSidebarContainer, me, n && ue),
            onTransitionEnd: (e) => {
          ...
          a.createElement(
            be,
            null,
            a.createElement(ce, { sidebar: t, path: r, onCollapse: d, isHidden: c }),
          ),
          c && a.createElement(de, { toggleSidebar: d }),
        );
      }
      const he = {
      ...
      function Ce(e) {
        ...
        return a.createElement(
          a.Fragment,
          null,
          a.createElement(ke.Z, { version: t.version, tag: (0, r.os)(t.pluginId, t.version) }),
          a.createElement(
            c.FG,
            {
              className: (0, l.Z)(
            ...
            a.createElement(
              s.q,
              { version: t },
              a.createElement(d.b, { name: u, items: b }, a.createElement(ge, null, m)),
            ),
          ),
        );
      }
