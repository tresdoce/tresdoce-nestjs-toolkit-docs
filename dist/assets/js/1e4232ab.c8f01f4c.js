    ...
    6193: (e, t, r) => {
      ...
      function p(e) {
        ...
        return (0, a.kt)(
          ...
          (0, a.kt)('h1', { id: 'create-a-document' }, 'Create a Document'),
          (0, a.kt)(
            'p',
            null,
            'Documents are ',
            (0, a.kt)('strong', { parentName: 'p' }, 'groups of pages'),
            ' connected through:',
          ),
          (0, a.kt)(
            'ul',
            ...
            (0, a.kt)(
              'li',
              { parentName: 'ul' },
              (0, a.kt)('strong', { parentName: 'li' }, 'previous/next navigation'),
            ),
            (0, a.kt)(
              'li',
              { parentName: 'ul' },
              (0, a.kt)('strong', { parentName: 'li' }, 'versioning'),
            ),
          ),
          (0, a.kt)('h2', { id: 'create-your-first-doc' }, 'Create your first Doc'),
          (0, a.kt)(
            'p',
            null,
            'Create a markdown file at ',
            (0, a.kt)('inlineCode', { parentName: 'p' }, 'docs/hello.md'),
            ':',
          ),
          (0, a.kt)(
            'pre',
          ...
          (0, a.kt)(
            ...
            (0, a.kt)('inlineCode', { parentName: 'p' }, 'http://localhost:3000/docs/hello'),
            '.',
          ),
          (0, a.kt)('h2', { id: 'configure-the-sidebar' }, 'Configure the Sidebar'),
          (0, a.kt)(
            'p',
            null,
            'Docusaurus automatically ',
            (0, a.kt)('strong', { parentName: 'p' }, 'creates a sidebar'),
            ' from the ',
            (0, a.kt)('inlineCode', { parentName: 'p' }, 'docs'),
            ' folder.',
          ),
          (0, a.kt)('p', null, 'Add metadata to customize the sidebar label and position:'),
          (0, a.kt)(
            'pre',
            null,
            (0, a.kt)(
          ...
          (0, a.kt)(
            ...
            (0, a.kt)('inlineCode', { parentName: 'p' }, 'sidebars.js'),
            ':',
          ),
          (0, a.kt)(
            'pre',
