  ...
  [3548],
  {
    3905: (e, t, n) => {
      ...
      var s = r.createContext({}),
        ...
        m = r.forwardRef(function (e, t) {
          ...
          return n
            ? r.createElement(f, l(l({ ref: t }, u), {}, { components: n }))
      ...
      function d(e, t) {
        ...
        if ('string' == typeof e || o) {
          ...
          (c.originalType = e), (c.mdxType = 'string' == typeof e ? e : o), (l[1] = c);
    ...
    2503: (e, t, n) => {
      ...
      const s = 'anchorWithStickyNavbar_LWe7',
        i = 'anchorWithHideOnScrollNavbar_WYt5';
      function u(e) {
        let { as: t, id: n, ...u } = e;
        const {
        ...
        return 'h1' !== t && n
          ? o.createElement(
              t,
              (0, r.Z)({}, u, { className: (0, a.Z)('anchor', p ? i : s), id: n }),
              u.children,
              o.createElement(
                'a',
                {
          ...
          : o.createElement(t, (0, r.Z)({}, u, { id: void 0 }));
      }
    },
    3548: (e, t, n) => {
      'use strict';
      ...
      function b(e, t) {
        let n = e.replace(/\n$/, '');
        const { language: r, magicComments: o, metastring: a } = t;
        if (a && g.test(a)) {
          ...
          const t = o[0].className,
            r = d()(e)
              .filter((e) => e > 0)
              .map((e) => [e - 1, [t]]);
          return { lineClassNames: Object.fromEntries(r), code: n };
        }
        ...
        for (let d = 0; d < c.length; ) {
          ...
          i[t]
            ...
            : u[t]
            ? (s[u[t]].start = d)
            : p[t] && (s[p[t]].range += s[p[t]].start + '-' + (d - 1) + ','),
            c.splice(d, 1);
        }
        n = c.join('\n');
        const m = {};
      ...
      var v = n(5281);
      const k = 'codeBlockContainer_Ckt0';
      function E(e) {
        let { as: t, ...n } = e;
        const o = (function (e) {
        ...
        return r.createElement(
          t,
          (0, a.Z)({}, n, { style: o, className: (0, s.Z)(n.className, k, v.k.common.codeBlock) }),
        );
      }
      const N = {
      ...
      function B(e) {
        ...
        return r.createElement(
          ...
          r.createElement('code', { className: N.codeBlockLines }, t),
        );
      }
      const j = {
      ...
      var T = /\r\n|\r|\n/,
        ...
        _ = function (e, t) {
          ...
          return (o.root = n), (o.plain = O({}, n, { backgroundColor: null })), o;
        };
      function S(e, t) {
        var n = {};
        for (var r in e)
      ...
      const x = (function (e) {
          function t() {
            ...
            e.apply(this, n),
              w(this, 'getThemeDict', function (e) {
                ...
                var n = e.theme ? _(e.theme, e.language) : void 0;
              ...
              w(this, 'getLineProps', function (e) {
                ...
                return (
                  ...
                  void 0 !== o && (a.style = void 0 !== a.style ? O({}, a.style, o) : o),
                  void 0 !== n && (a.key = n),
                  r && (a.className += ' ' + r),
                  a
                );
              ...
              w(this, 'getTokenProps', function (e) {
                var n = e.key,
                  ...
                  o = e.style,
                  a = e.token,
                  l = O({}, S(e, ['key', 'className', 'style', 'token']), {
                ...
                return (
                  void 0 !== o && (l.style = void 0 !== l.style ? O({}, l.style, o) : o),
                  void 0 !== n && (l.key = n),
                  r && (l.className += ' ' + r),
                  l
                );
              }),
              w(this, 'tokenize', function (e, t, n, r) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return o({
                tokens: (function (e) {
                  for (
                    var t = [[]], n = [e], r = [0], o = [e.length], a = 0, l = 0, c = [], s = [c];
                    l > -1;
                    ...
                    for (; (a = r[l]++) < o[l]; ) {
                      ...
                      if (
                        ('string' == typeof p
                          ? ((u = l > 0 ? u : ['plain']), (i = p))
                          : ((u = L(u, p.type)), p.alias && (u = L(u, p.alias)), (i = p.content)),
                        'string' == typeof i)
                      ) {
                        var m = i.split(T),
                          d = m.length;
                        c.push({ types: u, content: m[0] });
                        for (var f = 1; f < d; f++)
                          Z(c), s.push((c = [])), c.push({ types: u, content: m[f] });
                      } else l++, t.push(u), n.push(i), r.push(0), o.push(i.length);
                    }
        ...
        A = 'codeLineContent_feaV';
      function D(e) {
        let { line: t, classNames: n, showLineNumbers: o, getLineProps: l, getTokenProps: c } = e;
        1 === t.length && '\n' === t[0].content && (t[0].content = '');
        const i = l({ line: t, className: (0, s.Z)(n, o && P) }),
          u = t.map((e, t) =>
            r.createElement('span', (0, a.Z)({ key: t }, c({ token: e, key: t }))),
          );
        return r.createElement(
          'span',
          i,
          o
            ? r.createElement(
                ...
                r.createElement('span', { className: A }, u),
              )
            : r.createElement(r.Fragment, null, u, r.createElement('br', null)),
        );
      }
      var V = n(5999);
      const z = {
        ...
        const [o, a] = (0, r.useState)(!1),
          ...
          c = (0, r.useCallback)(() => {
            !(function (e, t) {
              ...
              r.remove(), l && (a.removeAllRanges(), a.addRange(l)), o && o.focus();
            })(t),
              a(!0),
        ...
        return (
          ...
          r.createElement(
            'button',
            {
              ...
              className: (0, s.Z)('clean-btn', n, z.copyButton, o && z.copyButtonCopied),
              onClick: c,
            },
            r.createElement(
              'span',
              { className: z.copyButtonIcons, 'aria-hidden': 'true' },
              r.createElement(
                'svg',
                { className: z.copyButtonIcon, viewBox: '0 0 24 24' },
              ...
              r.createElement(
                'svg',
                { className: z.copyButtonSuccessIcon, viewBox: '0 0 24 24' },
                r.createElement('path', {
      ...
      const W = 'wordWrapButtonIcon_Bwma',
        H = 'wordWrapButtonEnabled_EoeP';
      function R(e) {
        ...
        return r.createElement(
          'button',
          {
            type: 'button',
            onClick: n,
            className: (0, s.Z)('clean-btn', t, o && H),
            'aria-label': a,
            title: a,
          },
          r.createElement(
            'svg',
            { className: W, viewBox: '0 0 24 24', 'aria-hidden': 'true' },
            r.createElement('path', {
              fill: 'currentColor',
      ...
      function F(e) {
        ...
        const {
            prism: { defaultLanguage: d, magicComments: g },
          } = (0, u.L)(),
          y =
            null !=
            (t =
          ...
          v = (function () {
            const [e, t] = (0, r.useState)(!1),
              ...
              l = (0, r.useCallback)(() => {
                ...
                e ? n.removeAttribute('style') : (n.style.whiteSpace = 'pre-wrap'), t((e) => !e);
              }, [a, e]),
              c = (0, r.useCallback)(() => {
            ...
            return (
              ...
              { codeBlockRef: a, isEnabled: e, isCodeScrollable: n, toggle: l }
            );
          })(),
          k =
            (function (e) {
              var t, n;
              return null != (t = null == e || null == (n = e.match(f)) ? void 0 : n.groups.title)
                ? t
                : '';
            })(l) || c,
          { lineClassNames: B, code: j } = b(n, { metastring: l, language: y, magicComments: g }),
          w =
            null != i
              ? i
              : (function (e) {
        ...
        return r.createElement(
          ...
          {
            as: 'div',
            className: (0, s.Z)(o, y && !o.includes('language-' + y) && 'language-' + y),
          },
          k && r.createElement('div', { className: N.codeBlockTitle }, k),
          r.createElement(
            'div',
            { className: N.codeBlockContent },
            r.createElement(
              x,
              (0, a.Z)({}, C, { theme: h, code: j, language: null != y ? y : 'text' }),
              (e) => {
                ...
                return r.createElement(
                  ...
                  r.createElement(
                    'code',
                    { className: (0, s.Z)(N.codeBlockLines, w && N.codeBlockLinesWithNumbering) },
                    n.map((e, t) =>
                      r.createElement(D, {
                        key: t,
                        line: e,
            ...
            r.createElement(
              ...
              r.createElement(M, { className: N.codeButton, code: j }),
            ),
          ),
        );
      }
      function q(e) {
        ...
        const o = (0, c.Z)(),
          l = (function (e) {
            return r.Children.toArray(e).some((e) => (0, r.isValidElement)(e))
              ? e
              : Array.isArray(e)
              ? e.join('')
              : e;
          })(t),
          s = 'string' == typeof l ? F : B;
        return r.createElement(s, (0, a.Z)({ key: String(o) }, n), l);
      }
      var $ = n(9960);
      var G = n(6043);
      const Y = 'details_lb9f',
        U = 'isBrowser_bmU9',
        J = 'collapsibleContent_i85q';
      function K(e) {
      ...
      function Q(e) {
        ...
        const l = (0, c.Z)(),
          i = (0, r.useRef)(null),
          { collapsed: u, setCollapsed: p } = (0, G.u)({ initialState: !o.open }),
          [m, d] = (0, r.useState)(o.open);
        return r.createElement(
          'details',
          (0, a.Z)({}, o, {
            ref: i,
            open: m,
            'data-collapsed': u,
            className: (0, s.Z)(Y, l && U, o.className),
            onMouseDown: (e) => {
            ...
            onClick: (e) => {
              e.stopPropagation();
              const t = e.target;
              K(t) && X(t, i.current) && (e.preventDefault(), u ? (p(!1), d(!0)) : p(!0));
            },
          }),
      ...
      const ee = 'details_b_Ee';
      function te(e) {
        let { ...t } = e;
        return r.createElement(
          Q,
          (0, a.Z)({}, t, { className: (0, s.Z)('alert alert--info', ee, t.className) }),
        );
      }
      var ne = n(2503);
      function re(e) {
        return r.createElement(ne.Z, e);
      }
      const oe = 'containsTaskList_mC6p';
      const ae = 'img_ev3q';
      const le = {
        head: function (e) {
        ...
        code: function (e) {
          const t = ['a', 'b', 'big', 'i', 'span', 'em', 'strong', 'sup', 'sub', 'small'];
        ...
        details: function (e) {
          const t = r.Children.toArray(e.children),
            n = t.find((e) => {
              var t;
              return (
                r.isValidElement(e) && 'summary' === (null == (t = e.props) ? void 0 : t.mdxType)
              );
            }),
            o = r.createElement(
              r.Fragment,
          ...
          return r.createElement(te, (0, a.Z)({}, e, { summary: n }), o);
        },
        ul: function (e) {
          return r.createElement(
            'ul',
            (0, a.Z)({}, e, {
              className:
                ((t = e.className),
                (0, s.Z)(t, (null == t ? void 0 : t.includes('contains-task-list')) && oe)),
            }),
          );
          var t;
        },
        img: function (e) {
          return r.createElement(
            'img',
            (0, a.Z)({ loading: 'lazy' }, e, { className: ((t = e.className), (0, s.Z)(t, ae)) }),
          );
          var t;
        },
        h1: (e) => r.createElement(re, (0, a.Z)({ as: 'h1' }, e)),
        h2: (e) => r.createElement(re, (0, a.Z)({ as: 'h2' }, e)),
        h3: (e) => r.createElement(re, (0, a.Z)({ as: 'h3' }, e)),
        h4: (e) => r.createElement(re, (0, a.Z)({ as: 'h4' }, e)),
        h5: (e) => r.createElement(re, (0, a.Z)({ as: 'h5' }, e)),
        h6: (e) => r.createElement(re, (0, a.Z)({ as: 'h6' }, e)),
      };
      function ce(e) {
        let { children: t } = e;
        return r.createElement(o.Zo, { components: le }, t);
      }
    },
    7594: (e, t) => {
      function n(e) {
